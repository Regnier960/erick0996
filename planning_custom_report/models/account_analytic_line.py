...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    x_achived_task_in_date = fields.Boolean(string='Task Achived In Date', group_opeartor='bool_or',
    ...
    x_remaining_hours = fields.Float(string="Difference with planned hours", compute='_get_difference_planned_and_effective_hours',
                                     store=True, readonly=True,
                                     help="Difference between initial planned hours and effective hours")
